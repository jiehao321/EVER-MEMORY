...
function buildPreferenceGraph(profile) {
    try {
...
export function evermemoryProfile(profileService, profileRepo, input = {}) {
        ...
        return {
            ...
            summary: profile
                ? {
                    ...
                    derivedHintFields: profile.derived.likelyInterests.length
    ...
    return {
        ...
        summary: latest
            ? {
                ...
                derivedHintFields: latest.derived.likelyInterests.length
...
export async function evermemoryOnboard(onboardingService, input) {
    const userId = input.userId?.trim();
    if (!userId) {
        return {
