...
export function explainWrite(event) {
...
export function explainRetrieval(event) {
...
export function explainRule(event) {
...
export function explainSession(event) {
...
export function explainArchive(event) {
...
export function explainIntent(event) {
