export interface ProfilePatternRule {
  key: string;
  value: string;
  regex: RegExp;
}
...
export const WORK_PATTERN_RULES: ProfilePatternRule[] = [
...
export const COMMUNICATION_STYLE_RULES: Array<{ value: string; regex: RegExp }> = [
