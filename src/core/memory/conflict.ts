...
export interface ConflictPair {
  readonly memoryA: MemoryItem;
  readonly memoryB: MemoryItem;
...
function sameScope(left: MemoryItem, right: MemoryItem): boolean {
...
function topKeywords(content: string): string[] {
...
function antonymCount(left: string, right: string): number {
...
function buildConflictScore(similarity: number, sharedKeywords: number, antonyms: number): number {
...
function isConflictCandidate(current: MemoryItem, other: MemoryItem, similarity: number): ConflictPair | null {
