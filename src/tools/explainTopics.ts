...
export function explainRetrieval(event: DebugEvent): EverMemoryExplainToolResult['items'][number] {
...
export function explainRule(event: DebugEvent): EverMemoryExplainToolResult['items'][number] {
...
export function explainSession(event: DebugEvent): EverMemoryExplainToolResult['items'][number] {
...
export function explainArchive(event: DebugEvent): EverMemoryExplainToolResult['items'][number] {
...
export function explainIntent(event: DebugEvent): EverMemoryExplainToolResult['items'][number] {
