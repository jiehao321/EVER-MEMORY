...
export const PHASE28_BUTLER_ACTIONS_SCHEMA_VERSION = 28;
export const PHASE29_BUTLER_INTELLIGENCE_SCHEMA_VERSION = 29;
export const PHASE30_BUTLER_EVOLUTION_SCHEMA_VERSION = 30;
export const PHASE31_FTS5_SCHEMA_VERSION = 31;
export const CURRENT_SCHEMA_VERSION = PHASE31_FTS5_SCHEMA_VERSION;
