...
import { RANKING_APPLY_COUNT_DIVISOR, RANKING_FRESHNESS_BRACKETS, RANKING_LEVEL_WEIGHT_BASELINE, RANKING_LEVEL_WEIGHT_CANDIDATE, RANKING_LEVEL_WEIGHT_CRITICAL, RANKING_MATURITY_WEIGHT_EMERGING, RANKING_MATURITY_WEIGHT_FROZEN, RANKING_MATURITY_WEIGHT_INSTITUTIONALIZED, RANKING_MATURITY_WEIGHT_VALIDATED, RANKING_MAX_DECAY_PENALTY, RANKING_RECURRENCE_DIVISOR, RANKING_STALE_GOVERNANCE_PENALTY, RANKING_WEIGHT_APPLICABILITY, RANKING_WEIGHT_APPLY_COUNT, RANKING_WEIGHT_CONFIDENCE, RANKING_WEIGHT_FRESHNESS, RANKING_WEIGHT_LEVEL, RANKING_WEIGHT_MATURITY, RANKING_WEIGHT_PRIORITY, RANKING_WEIGHT_RECURRENCE, } from '../../tuning.js';
...
export function rankBehaviorRules(rules, input) {
    const ranked = rules
        .map((rule) => {
        ...
        const score = applicability.score * RANKING_WEIGHT_APPLICABILITY
