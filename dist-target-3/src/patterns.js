...
export const PROJECT_COMPACT_PATTERNS = [
...
export const PROJECT_STATUS_PATTERNS = [
...
export const PROJECT_PROGRESS_ROUTE_PATTERNS = [
...
export const PROJECT_STAGE_ROUTE_PATTERNS = [
...
export const WRITE_PREFERENCE_PATTERNS = [
...
export const WRITE_CONSTRAINT_PATTERNS = [
...
export const WRITE_DECISION_PATTERNS = [
...
/** Memory-cue patterns. */
export const MEMORY_CUE_PATTERNS = [
...
export const EPHEMERAL_RULE_PATTERNS = [
