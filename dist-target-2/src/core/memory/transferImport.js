import { MAX_IMPORT_ITEMS, SNAPSHOT_FORMAT, describeType, emptyImportResult, formatValue, pushRejection, sanitizeImportMemory, validateImportMemory, } from './transferShared.js';
export function importSnapshot(deps, input) {
