import { BEHAVIOR_AGING_AFTER_DAYS, BEHAVIOR_APPLY_DECAY_RECOVERY, BEHAVIOR_DECAY_FROM_AGING, BEHAVIOR_DECAY_FROM_EXPIRED, BEHAVIOR_DECAY_FROM_STALE, BEHAVIOR_DECAY_PER_CONTRADICTION, BEHAVIOR_EXPIRED_AFTER_DAYS, BEHAVIOR_EXPIRES_AFTER_DAYS, BEHAVIOR_MATURITY_INSTITUTIONALIZED_THRESHOLD, BEHAVIOR_MATURITY_VALIDATED_THRESHOLD, BEHAVIOR_MAX_CONTRADICTIONS_BEFORE_DISABLE, BEHAVIOR_MIN_PRIORITY, BEHAVIOR_PRIORITY_CORRECTION_PENALTY, BEHAVIOR_PRIORITY_DECAY_STEP, BEHAVIOR_STALE_AFTER_DAYS, BEHAVIOR_STALE_VALIDATED_THRESHOLD, LEVEL_BASELINE_CONFIDENCE_THRESHOLD, LEVEL_BASELINE_PRIORITY_THRESHOLD, LEVEL_CRITICAL_CONFIDENCE_THRESHOLD, LEVEL_CRITICAL_PRIORITY_THRESHOLD, } from '../../tuning.js';
...
function deduceMaturity(applyCount, contradictionCount) {
...
function deduceLevel(priority, confidence) {
...
export function evaluateBehaviorLifecycle(rule, now = new Date()) {
...
export function markBehaviorRuleApplied(rule, now = new Date()) {
    const nowIso = now.toISOString();
...
export function markBehaviorRuleContradicted(rule, input = {}) {
...
export function freezeBehaviorRule(rule, reason, now = new Date()) {
    const nowIso = now.toISOString();
    return evaluateBehaviorLifecycle({
        ...rule,
        updatedAt: nowIso,
