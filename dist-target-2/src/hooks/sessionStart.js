...
import { normalizeCommunicationStyle } from '../core/briefing/service.js';
...
function buildUserProfile(profile) {
    return {
        ...
        explicitPreferences: Object.freeze(Object.fromEntries(Object.entries(profile.stable.explicitPreferences).map(([key, value]) => [key, value.value]))),
        displayName: profile.stable.displayName?.value,
    };
}
export function handleSessionStart(input, briefingService, behaviorService, debugRepo, profileRepo) {
