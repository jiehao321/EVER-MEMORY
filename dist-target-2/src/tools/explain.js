import { explainArchive, explainIntent, explainRetrieval, explainRule, explainSession, explainWrite, } from './explainTopics.js';
const EVENT_KINDS_BY_TOPIC = {
...
function toExplanation(topic, event) {
    switch (topic) {
        case 'write':
...
export function evermemoryExplain(debugRepo, input = {}) {
    const topic = input.topic ?? 'write';
